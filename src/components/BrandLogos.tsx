...
export function VisaLogo(props: IconProps) {
  return (
    <svg viewBox="0 0 120 40" fill="currentColor" {...props}>
      <path d="M45.1 36.8h-7.7l4.8-29.6h7.7l-4.8 29.6zm29.8-29h-6c-1.9 0-3.3.5-4.1 2.5l-11.7 26.5h8.1l1.6-4.5h9.9l0.9 4.5h7.1l-5.8-29zm-7.9 16.4l3.3-9.1c-.1.2.7-1.9.7-1.9l.4 2 1.9 9h-6.3zm-31.5-16.4l-7.4 20.2-0.8-4c-1.4-4.8-5.8-10-10.7-12.6l6.8 26h8.1l12.1-29.6h-8.1zm-24.9 0h-10.5l-.1.6c8.2 2.1 13.6 7.1 15.9 13.2l-2.3-11.4c-.4-1.8-1.7-2.3-3-2.4z" />
    </svg>
  );
}
